            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <section>
                    <div className="border p-6 rounded-lg shadow-lg bg-green-100">
                        <h2 className="text-2xl font-semibold mb-4 text-green-600">{translations[language].contactUs}</h2>
                        <p className="text-gray-700 mt-2"><strong>Address:</strong> {translations[language].address}</p>
                        <p className="text-gray-700 mt-2"><strong>Email:</strong> {translations[language].email}</p>
                        <p className="text-gray-700 mt-2"><strong>Phone:</strong> {translations[language].phone}</p>
                        <Link href="/">
                            <button className="bg-green-700 text-white mt-4 px-6 py-2 rounded-lg hover:bg-green-600">{translations[language].visitUs}</button>
                        </Link>
                    </div>
                </section>
            </div>
