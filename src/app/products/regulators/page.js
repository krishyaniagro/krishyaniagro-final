...
const Products = () => {
    ...
    { id: "allrounder", name: { en: 'All Rounder ', mr: 'ऑलराऊंडर ', hi: 'ऑलराऊंडर ' }, MRP: '₹ 590', price: '₹ 630', image: '/product_multiple/allrounder2.png', description: { en: 'All Rounder increases fruit quality, size, weight & over all yield', mr: 'ऑलराऊंडर फळांचा दर्जा, आकार, वजन आणि एकूण उत्पादन वाढवतो.', hi: 'ऑलराउंडर फल की गुणवत्ता, आकार, वजन और कुल उपज बढ़ाता है।' } },
      ];
