export const products = [
    { id: "real_power", name: { en: 'Real Power ', mr: 'रियल पावर', hi: 'रियल पावर' }, MRP: '₹ 998', price: '₹ 650', image: '/images/krushi_f1.jpg', description: { en: 'High-performance fertilizer for healthy plant growth.', mr: 'आरोग्यकर्ता पाऊस उभारण्यासाठी उच्च-क्रियाशील खत.', hi: 'स्वस्थ पौधे के विकास के लिए उच्च प्रदर्शन उर्वरक।' } },
