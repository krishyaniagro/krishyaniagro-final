...
// //             <p className="mt-2">
// //               {translations[language].email}: <a href="mailto:info@Krishyaniagro.com" className="hover:underline">krishyaniagro24@gmail.com </a>
// //             </p>
// //             <p className="mt-2">
...
//       email: "Email",
//       phone: "Phone",
//       address: "Address: Floor No.: Third Floor, SAI SANSKRUTI BAIF, Pune Nagar Road Wagheshwar Mandir Wagholi, Pune, Pincode 412207",
//       companyInfo: "Empowering farmers with technology and providing fresh produce to everyone.",
//       pages: "Pages",
...
//       email: "ईमेल",
//       phone: "फोन",
//       address: "पत्ता: तिसरा मजला, साई संस्कृती बाइफ, पुणे नगर रोड वाघेश्वर मंदिर, वाघोली, पुणे, पिनकोड 412207",
//       companyInfo: "तंत्रज्ञानासह शेतकऱ्यांना सक्षम बनवणे आणि सर्वांना ताजे उत्पादन प्रदान करणे.",
//       pages: "पृष्ठे",
...
//       email: "ईमेल",
//       phone: "फ़ोन",
//       address: "पता: तीसरी मंजिल, साई संस्कृति बाइफ, पुणे नगर रोड वाघेश्वर मंदिर, वाघोली, पुणे, पिनकोड 412207",
//       companyInfo: "किसानों को प्रौद्योगिकी के साथ सशक्त बनाना और सभी को ताजा उत्पाद प्रदान करना।",
//       pages: "पृष्ठ",
...
//         <div className="flex flex-wrap">
//           <div className="w-full md:w-1/4 mb-6 md:mb-0">
//             <h2 className="text-xl font-bold text-[#304330]">Krishyaniagro</h2>
//             <p className="mt-2 text-[#304330]">
//               {translations[language].companyInfo}
//             </p>
//           </div>
...
//               <li className="mt-1">
//                 <Link href="/">
//                   <p className="hover:underline text-[#304330]">{translations[language].home}</p>
//                 </Link>
//               </li>
//               <li className="mt-1">
//                 <Link href="/about">
//                   <p className="hover:underline text-[#304330]">{translations[language].about}</p>
//                 </Link>
//               </li>
//               <li className="mt-1">
//                 <Link href="/services">
//                   <p className="hover:underline text-[#304330]">{translations[language].services}</p>
//                 </Link>
//               </li>
//               <li className="mt-1">
//                 <Link href="/contact">
//                   <p className="hover:underline text-[#304330]">{translations[language].contact}</p>
//                 </Link>
//               </li>
//             </ul>
//           </div>
...
//           <div className="w-full md:w-1/4 mb-6 md:mb-0">
//             <h3 className="text-lg font-semibold text-[#304330]">{translations[language].followUs}</h3>
//             <div className="mt-2 flex space-x-4">
//               {/* Social Media Links */}
//               <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="#304330" viewBox="0 0 24 24">
//                   <path d="M24 4.56c-.88.39-1.82.66-2.8.78 1.01-.61 1.78-1.58 2.15-2.73-.95.56-2 .96-3.13 1.18-.89-.95-2.17-1.54-3.58-1.54-2.71 0-4.9 2.19-4.9 4.89 0 .38.04.75.13 1.11-4.07-.2-7.69-2.15-10.11-5.12-.42.73-.66 1.57-.66 2.48 0 1.71.87 3.22 2.19 4.1-.81-.03-1.57-.25-2.23-.62v.06c0 2.38 1.69 4.36 3.94 4.81-.41.11-.84.17-1.28.17-.31 0-.61-.03-.91-.08.61 1.9 2.39 3.29 4.5 3.33-1.65 1.29-3.74 2.06-6 2.06-.39 0-.77-.02-1.15-.07 2.14 1.37 4.68 2.17 7.41 2.17 8.89 0 13.76-7.36 13.76-13.75 0-.21 0-.42-.02-.63.95-.68 1.78-1.53 2.43-2.5z" />
//                 </svg>
//               </a>
//               <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
...
//         <div className="mt-8 border-t border-white-700 pt-4">
//           <p className="text-center text-sm text-[#304330]" dangerouslySetInnerHTML={{ __html: translations[language].copyright }}></p>
//         </div>
//       </div>
//     </footer>
//   );
...
<div>
            ...
            <ul className="mt-2 space-y-2 text-[#304330]">
              <li>
                <Link href="/services">
                  <p className="hover:underline text-[#304330]">{translations[language].service1}</p>
                </Link>
              </li>
              <li>
                <Link href="/services">
                  <p className="hover:underline text-[#304330]">{translations[language].service2}</p>
                </Link>
              </li>
              <li>
                <Link href="/services">
                  <p className="hover:underline text-[#304330]">{translations[language].service3}</p>
                </Link>
              </li>
              <li>
                <Link href="/services">
                  <p className="hover:underline text-[#304330]">{translations[language].serivce4}</p>
                </Link>
              </li>
            </ul>
          </div>
